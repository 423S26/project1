        ...
        <div style={{ color: sage[500] }} className="flex max-w-6xl mx-auto py-10">
            <div className="w-64 pr-8 border-r">
              ...
              <ul className=" main-section space-y-3 text-sm">
                ...
                <li><a href="#unique">Why It's Unique</a></li>
                <li><a href="#access">Accessing the Software</a></li>
                <li><a href="#tutorial">Using The App</a></li>
                <li><a href="#issues">Known Issues</a></li>
                <li><a href="#requirements">Requirements</a></li>
                <li><a href="#devdocs">Development Docs</a></li>
              </ul>
            </div>
            ...
            <div  className="flex-1 pl-10 space-y-10">
                ...
                <h1 className="accent-section text-3xl font-bold mb-3 font-SatisfyR" > Asian Art App - User Documentation  </h1>
                    ...
                    <p className= "main-section  leading-relaxed"> The <strong>Asian Art App</strong> is a web-based platform that allows users
                    ...
                    <p className= "main-section  leading-relaxed">
                ...
                <section id="features">
                    ...
                    <ul className="main-section list-disc ml-6 space-y-1 ">
                ...
                <section id="access">
                    ...
                    <p className= "main-section  leading-relaxed"> The application is hosted online via Netlify </p>
                    <p className= "main-section  leading-relaxed"> Users can access the application directly through their web browser </p>
                    <p className= "main-section  leading-relaxed"> No installation is required</p>
                </section>
                ...
                <section id="tutorial">
                    ...
                    <ol className="main-section list-decimal ml-6 space-y-1 ">
                    ...
                    <p className="main-section  leading-relaxed">The Shop allows users to browse and post items for sale.</p>
                    ...
                    <p className="main-section  leading-relaxed mt-1 text-sm italic">Note: You must be signed in to see the Contact Seller button. You will not see this button on your own listings.</p>
                    ...
                    <p className="main-section  leading-relaxed mt-1 text-sm italic">Note: You can only delete listings you created. This action cannot be undone.</p>



                    <h2 className="accent-section text-xl font-semibold mb-2">Community Page</h2>
                    <p className="main-section  leading-relaxed">The Community page is for sharing and discovering local cultural events.</p>
                ...
                <section id="issues">
                    ...
                    <p className= "main-section  leading-relaxed">Listed are bugs we already know and are working to fix:</p>
                    <ul className="main-section list-disc ml-6 space-y-1 ">
                ...
                <section id="requirements">
                    ...
                    <p className= "main-section  leading-relaxed"> Stable Internet connection</p>
                    <p className= "main-section  leading-relaxed"> Modern web browser (ex. Chrome, Firefox, Safari, etc.)</p>
                    <p className= "main-section  leading-relaxed"> An email address to create an account </p>
                </section>

                <section id="devdocs">
                <h2 className="accent-section text-xl font-semibold mb-2"> Developer Details</h2>
                <p className= "main-section  leading-relaxed">For technical documentation including setup instructions architecture details, and contribution guidelines: please follow <a href="https://github.com/423S26/project1/blob/main/README.md" target="_blank" rel="noopener noreferrer"
                                     style={{
                                         color: '#8B9D83',
