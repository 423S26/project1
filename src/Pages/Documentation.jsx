    ...
    return (
        <div className="flex max-w-6xl mx-auto py-10">
            ...
            <div className="flex-1 pl-10 space-y-10">
                <section id="overview">
                <h1 className="text-3xl font-bold mb-3"> Asian Art App - User Documentation </h1>

                    <p className= "text-gray-700 leading-relaxed"> The <strong>Asian Art App</strong> is a web-based platform that allows users
                ...
                <section id="unique">
                    <h2 className="text-xl font-semibold mb-2"> Why the application is unique:</h2>
                    <ul className="list-disc ml-6 space-y-1 text-gray-700">
                    ...
                    <h2 className="text-xl font-semibold mb-2"> This software is valuable because it:</h2>
                    <ul className="list-disc ml-6 space-y-1 text-gray-700">
                ...
                <section id="access">
                    <h2 className="text-xl font-semibold mb-2"> How to access the Software: </h2>
                    <p className= "text-gray-700 leading-relaxed"> The application is hosted online via Netlify </p>
                    <p className= "text-gray-700 leading-relaxed"> Users can access the application directly through their web browser </p>
                    <p className= "text-gray-700 leading-relaxed"> No installation is required</p>
                </section>

                <section id="tutorial">
                   <h2 className="text-xl font-semibold mb-2"> Using the App: </h2>
                   <p className= "text-gray-700 leading-relaxed"> Users can view and create product and event listings only after signing in to the app</p>
                   <p className= "text-gray-700 leading-relaxed"> Simply click on a post to view details, contact sellers, and save events </p>
                   <p className= "text-gray-700 leading-relaxed"> <strong>Users can only delete posts that they own.</strong> A delete button will appear when signed in to the account that created the listing</p>
                   <p className= "text-gray-700 leading-relaxed"> Contacting a seller and getting updates about an event are done through a users email </p>
                </section>

                <section id="issues">
                    <h2 className="text-xl font-semibold mb-2"> Known Issues </h2>
                    <p className= "text-gray-700 leading-relaxed">Listed are bugs we already know and are working to fix:</p>
                    <ul className="list-disc ml-6 space-y-1 text-gray-700">
                ...
                <section id="requirements">
                    ...
                    <p className= "text-gray-700 leading-relaxed"> Internet connection</p>
                    <p className= "text-gray-700 leading-relaxed"> Modern web browser</p>
                </section>

                <section id="devdocs">
                <h2 className="text-xl font-semibold mb-2"> If you want to look into Development Documentation</h2>
                <p className= "text-gray-700 leading-relaxed"> please follow <a href="https://github.com/423S26/project1/blob/main/README.md" target="_blank" rel="noopener noreferrer"
                                     style={{
                                         color: '#8B9D83',
